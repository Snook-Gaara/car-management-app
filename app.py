...
if 'cars' not in st.session_state:
    st.session_state.cars = [
        {"ยี่ห้อ": "Toyota Camry", "ทะเบียน": "กข-123", "สถานะ": "ว่าง", "คนใช้": "-", "สถานที่": "-"},
        {"ยี่ห้อ": "Honda Civic", "ทะเบียน": "ขง-456", "สถานะ": "ว่าง", "คนใช้": "-", "สถานที่": "-"},
        {"ยี่ห้อ": "Isuzu D-Max", "ทะเบียน": "คจ-789", "สถานะ": "ว่าง", "คนใช้": "-", "สถานที่": "-"},
        {"ยี่ห้อ": "Tesla Model 3", "ทะเบียน": "งด-001", "สถานะ": "ว่าง", "คนใช้": "-", "สถานที่": "-"},
    ]
